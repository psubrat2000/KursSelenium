...
public class PrestaTest {
    ...
    public void testPresta() {
        ...
        for (int j = 0; j < testCases; j++) {
            ...
            if (email.isEnabled()) {
                String[] email1 = {"Markowski", "Geller", "Bing", "Buffay", "Green", "Tribbiani", "Schwimmer", "Perry", "LeBlanc", "Aniston", "Cox", "Kudrow"};
                String[] email2 = {"@gmail.com", "@email.com", "@yahoo.com", "@bing.com", "@onet.pl", "@aol.com", "@wp.pl", "@proton.com", "@web.de"};
                rand1 = random.nextInt(email1.length);
                rand2 = random.nextInt(9999) + 1;
                rand3 = random.nextInt(email2.length);
                email.sendKeys(email1[rand1] + rand2 + email2[rand3]);
            } else {
